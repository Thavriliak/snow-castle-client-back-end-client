  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested inventory" do
        inventory = Inventory.create! valid_attributes
        put :update, params: {id: inventory.to_param, inventory: new_attributes}, session: valid_session
        inventory.reload
      ...
      it "renders a JSON response with the inventory" do
        ...
        put :update, params: {id: inventory.to_param, inventory: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "renders a JSON response with errors for the inventory" do
        ...
        put :update, params: {id: inventory.to_param, inventory: invalid_attributes}, session: valid_session
        expect(response).to have_http_status(:unprocessable_entity)
        expect(response.content_type).to eq('application/json')
      end
    end
